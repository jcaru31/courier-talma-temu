    ...
    <div className="fixed inset-0 z-50" aria-modal="true">
      ...
      >
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-border px-4 py-3">
          {/* Fila 1: título + agente a la derecha + cerrar */}
          <div className="flex items-start gap-3">
            ...
            {awb?.consignatario_nombre && (
              <div className="ml-auto self-end text-right min-w-0 max-w-[55%]">
                <div className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                  Consignatario
                </div>
                <div className="text-[13px] font-bold text-slate-700 leading-tight truncate">
                  {awb.consignatario_nombre}
                </div>
              </div>
            )}
